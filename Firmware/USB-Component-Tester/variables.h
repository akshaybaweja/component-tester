 ...
 */
  ...
  const unsigned char Version_str[] EEMEM = "v1.0";
  ...
  /* options */
    ...
    const unsigned char IR_uPD1986C_str[] EEMEM = "�PD1986C";
    #endif
  #endif
  ...
  /* remote commands */
    ...
    const unsigned char Cmd_PROBE_ID_str[] EEMEM = "PROBE_ID";
 ...
 */
  ...
  extern const unsigned char probe_colors_str[];
  ...
  /* remote commands */
    ...
    extern const unsigned char Cmd_PROBE_ID_str[];
